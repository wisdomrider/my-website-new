    ...
    return (
        <div style={{ width: 240 }}>
            ...
            <Carousel
                ...
                {pageProps.appList&& <div style={{ overflow: 'scroll', overflowX: 'hidden' }}>
                    {pageProps.appList.map((item, i) => <motion.div key={i} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.8 }} onClick={() => window.open(item.appLink, '_blank')} className="flex app-card flex-ac">
